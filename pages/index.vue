...
<template>
    <section id="home" style="background: linear-gradient(to right, #000000 50%, #ffffff 50%);" class="min-h-screen grid grid-cols-2 ease-in-out duration-500 transition-all">
        <div class="absolute w-full h-full grid place-items-center">
            <div class="grid place-items-center">
                <div data-aos="zoom-in-down" class="overflow-hidden bg-red-200">
		...
		C238,137.059,229.028,128.088,218,128.088z" />
                ...
                <br>
                <h1 data-aos="zoom-in-up" data-aos-delay="1000" class="text-lg sm:text-xl md:text-3xl lg:text-4xl xl:text-5xl 2xl:text-6xl 3xl:text-8xl text-zinc-400 text-center mix-blend-difference">{{ job_title }}</h1>
            </div>
        </div>
    </section>
    <section id="about" style="background: linear-gradient(to right, #ffffff 50%, #000000 50%);" class="min-h-screen ease-in-out duration-500 transition-all">
        <div class="w-full h-full">
            <div class="px-10 pt-16 pt lg:p-[100px] ease-in-out duration-500 transition-all">
                ...
                <div data-aos="fade-up" data-aos-delay="2000" class="mix-blend-difference">
                    <NuxtLink to="#stack" class="text-sm lg:text-2xl 2xl:text-4xl text-black bg-white p-5 drop-shadow-lg dark:drop-shadow-none hover:text-white hover:bg-blue-700 transition-all duration-500">{{ read_more_button }}</NuxtLink>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="w-full h-full">
            <div class="px-10 pt-16 pt lg:p-[100px] ease-in-out duration-500 transition-all">
                ...
                <div class="grid grid-cols-3 pt-5 h-20 sm:h-24 md:h-32 justify-items-center">
                    ...
                    <div data-aos="fade-up" data-aos-delay="2000" class="">
                        <NuxtLink to="https://laravel.com/">
                            <svg class="w-full h-20 sm:h-24 md:h-32 inline fill-[#f9322c]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                                <title>laravel</title>
